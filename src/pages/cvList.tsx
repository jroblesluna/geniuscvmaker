    ...
    fetch('/assets/html/printTemplate.html')
      ...
      .then((template) => {
        const modifiedHTML = template.replace(
          '<div id="content"></div>',
          `<div id="content">${selectedCV || 'No hay contenido disponible'}</div>`
        );

        // Escribimos en el documento de la nueva ventana
      ...
      <body>
        ...
        // Usamos setTimeout para asegurar que el contenido se carga antes de imprimir
        setTimeout(() => {
          printWindow.print();
  ...
  return (
    <div className="container mx-auto px-4 pt-4 ">
      <div className="text-center mb-2">
        <h1 className="text-3xl font-bold">My CV's</h1>
      </div>
      <div className={`flex w-full  ${isSmallScreen ? 'flex-col' : 'flex-row'} gap-4`}>
        <div className={`w-full  flex flex-col`}>
          {isLoading ? (
            ...
            <>
              <div className="pb-5 flex flex-col items-end gap-4 ">
                <FilterDropdown
