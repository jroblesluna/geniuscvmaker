function SvgLoading() {
    return (
        <svg width="100%" height="100%" version="1.1" id="L3" viewBox="0 0 100 100" xmlSpace="preserve">
            ...
            <circle fill="transparent" stroke="#FFFFFF" strokeWidth="1" cx="50" cy="50" r="30"
            ...
            <text>
                <textPath xlinkHref="#circlePath" fill="#FFFFFF" startOffset="0%" fontSize={8}>
                    CV MAKER
                </textPath>
            </text>

            <circle fill="transparent" stroke="#FFFFFF" strokeWidth="1" cx="20" cy="50" r="2">
                <animateTransform
